...
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'لاريكا')
--     Source ZOLARS     --
...
if text and text:match('^'..(DevAbs:get(ZOLARS..'Abs:NameBot') or "لاريكا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(ZOLARS..'Abs:NameBot') or "لاريكا")..' ','')
end
...
local BotName = (DevAbs:get(ZOLARS.."Abs:NameBot") or 'لاريكا')
...
if text and text == (DevAbs:get(ZOLARS..'Abs:NameBot') or 'لاريكا') then 
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'لاريكا')
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './ZOLARS.lua', '₪╽نسخة ملف سورس لاريكا',dl_cb, nil)
end end
--     Source ZOLARS     --
