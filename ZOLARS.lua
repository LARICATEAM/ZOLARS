...
if not DevAbs:get(Server.."IdZOLARS") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevAbs:set(Server.."IdZOLARS",DevId) 
else 
print('\27[1;31m┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉') 
end 
os.execute('lua ZOLARS.lua') 
end 
if not DevAbs:get(Server.."TokenZOLARS") then 
...
DevAbs:set(Server.."TokenZOLARS",TokenBot) 
end  
else 
...
Config = {
DevId = DevAbs:get(Server.."IdZOLARS"),
TokenBot = DevAbs:get(Server.."TokenZOLARS"),
ZOLARS = DevAbs:get(Server.."TokenZOLARS"):match("(%d+)"),
SudoIds = {DevAbs:get(Server.."IdZOLARS")},
}
...
#!/usr/bin/env bash
cd $HOME/ZOLARS
token="]]..DevAbs:get(Server.."TokenZOLARS")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉"
...
f:close() 
DevAbs:del(Server.."IdZOLARS");DevAbs:del(Server.."TokenZOLARS")
end 
...
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'زولارس')
--     Source ZOLARS     --
...
local Status = DevAbs:sismember(ZOLARS..'Abs:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(ZOLARS..'Abs:SudoBot:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(ZOLARS..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(ZOLARS..'Abs:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevAbs:sismember(ZOLARS..'Abs:VipAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevAbs:sismember(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(ZOLARS..'Abs:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(ZOLARS..'Abs:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevAbs:sismember(ZOLARS..'Abs:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevAbs:sismember(ZOLARS..'Abs:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(ZOLARS..'Abs:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevAbs:sismember(ZOLARS..'Abs:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAbs:sismember(ZOLARS..'Abs:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevAbs:sismember(ZOLARS..'Abs:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAbs:sismember(ZOLARS..'Abs:MuteAll:', user_id) then
var = true
else
var = false
end
...
vardump(JsonInfo)
DevAbs:set(ZOLARS.."Abs:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevAbs:sadd(ZOLARS.."Abs:Groups",IdGps) 
DevAbs:set(ZOLARS.."Abs:Lock:Bots"..IdGps,"del") DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevAbs:set(ZOLARS..Lock..IdGps,true)
end
if v.AbsConstructors then
for k,IdAbsConstructors in pairs(v.AbsConstructors) do
DevAbs:sadd(ZOLARS..'Abs:AbsConstructor:'..IdGps,IdAbsConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevAbs:sadd(ZOLARS..'Abs:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevAbs:sadd(ZOLARS..'Abs:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevAbs:sadd(ZOLARS..'Abs:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevAbs:sadd(ZOLARS..'Abs:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevAbs:sadd(ZOLARS..'Abs:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevAbs:set(ZOLARS.."Abs:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevAbs:set(ZOLARS.."Abs:Groups:Welcomes"..IdGps,v.Welcomes)   
...
keyboard = {}
keyboard.inline_keyboard = {{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
...
--     Source ZOLARS     --
local AbsRank = function(msg) if SudoId(msg.sender_user_id_) then ZOLARSTEAM  = "المطور" elseif SecondSudo(msg) then ZOLARSTEAM = "المطور" elseif SudoBot(msg) then ZOLARSTEAM = "المطور" elseif ManagerAll(msg) then ZOLARSTEAM = "المدير" elseif AdminAll(msg) then ZOLARSTEAM = "الادمن" elseif AbsConstructor(msg) then ZOLARSTEAM = "المالك" elseif BasicConstructor(msg) then ZOLARSTEAM = "المنشئ" elseif Constructor(msg) then ZOLARSTEAM = "المنشئ" elseif Manager(msg) then ZOLARSTEAM = "المدير" elseif Admin(msg) then ZOLARSTEAM = "الادمن" else ZOLARSTEAM = "العضو" end return ZOLARSTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1573309498) then ZOLARSTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(ZOLARS) then ZOLARSTEAM = 'البوت' elseif SudoId(user_id) then ZOLARSTEAM = 'المطور الاساسي' elseif DevAbs:sismember(ZOLARS..'Abs:SecondSudo:', user_id) then ZOLARSTEAM = 'المطور الثانوي' elseif DevAbs:sismember(ZOLARS..'Abs:SudoBot:', user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(ZOLARS..'Abs:ManagerAll:', user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:Managers:Rd"..chat_id) or 'المدير العام' elseif DevAbs:sismember(ZOLARS..'Abs:AdminAll:', user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevAbs:sismember(ZOLARS..'Abs:VipAll:', user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevAbs:sismember(ZOLARS..'Abs:AbsConstructor:'..chat_id, user_id) then ZOLARSTEAM = 'المالك' elseif DevAbs:sismember(ZOLARS..'Abs:BasicConstructor:'..chat_id, user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(ZOLARS..'Abs:Constructor:'..chat_id, user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(ZOLARS..'Abs:Managers:'..chat_id, user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(ZOLARS..'Abs:Admins:'..chat_id, user_id) then ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(ZOLARS..'Abs:VipMem:'..chat_id, user_id) then  ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(ZOLARS..'Abs:Cleaner:'..chat_id, user_id) then  ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else ZOLARSTEAM = DevAbs:get(ZOLARS.."Abs:mem:Rd"..chat_id) or 'العضو' end return ZOLARSTEAM end
--     Source ZOLARS     --
...
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:SecondSudo:', user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:SudoBot:', user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:ManagerAll:', user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:AdminAll:', user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:VipAll:', user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:AbsConstructor:'..chat_id, user_id) then
var = true
elseif DevAbs:sismember(ZOLARS..'Abs:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevAbs:sismember(ZOLARS..'Abs:Constructor:'..chat_id, user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:Managers:'..chat_id, user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:Admins:'..chat_id, user_id) then
var = true  
elseif DevAbs:sismember(ZOLARS..'Abs:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local abs = (ZOLARS..'Abs:Filters:'..msg.chat_id_)
if abs then
...
local var = true 
if DevAbs:get(ZOLARS.."Abs:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevAbs:get(ZOLARS..'Abs:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevAbs:get(ZOLARS..'Abs:ChText') then
local ChText = DevAbs:get(ZOLARS..'Abs:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevAbs:get(ZOLARS.."Abs:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevAbs:get(ZOLARS..'yes'..data.sender_user_id_) == 'delyes' then
DevAbs:del(ZOLARS..'yes'..data.sender_user_id_, 'delyes')
DevAbs:del(ZOLARS..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevAbs:get(ZOLARS..'no'..data.sender_user_id_) == 'delno' then
DevAbs:del(ZOLARS..'yes'..data.sender_user_id_, 'delyes')
DevAbs:del(ZOLARS..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⌔╽تم الغاء امر اطردني") 
end
--     Source ZOLARS     --
if DataText == '/yesdel' and DevAbs:get(ZOLARS..'yesdel'..data.sender_user_id_) == 'delyes' then
DevAbs:del(ZOLARS..'yesdel'..data.sender_user_id_, 'delyes')
DevAbs:del(ZOLARS..'nodel'..data.sender_user_id_, 'delno')
if DevAbs:sismember(ZOLARS..'Abs:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAbs:sismember(ZOLARS..'Abs:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevAbs:sismember(ZOLARS..'Abs:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAbs:sismember(ZOLARS..'Abs:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAbs:sismember(ZOLARS..'Abs:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevAbs:sismember(ZOLARS..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
...
DevAbs:srem(ZOLARS..'Abs:Constructor:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:Managers:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:Admins:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:VipMem:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevAbs:srem(ZOLARS..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevAbs:get(ZOLARS.."Abs:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "⌔╽تم الغاء امر تغير المطور الاساسي") 
DevAbs:del(ZOLARS.."Abs:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevAbs:get(ZOLARS.."Abs:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevAbs:get(ZOLARS..'nodel'..data.sender_user_id_) == 'delno' then
DevAbs:del(ZOLARS..'yesdel'..data.sender_user_id_, 'delyes')
DevAbs:del(ZOLARS..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⌔╽تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevAbs:get(ZOLARS.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevAbs:smembers(ZOLARS..'Abs:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevAbs:del(ZOLARS..'Abs:ListRolet'..data.chat_id_) 
DevAbs:del(ZOLARS.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "⌔╽*صاحب الحظ* ↫ ["..UserName.."]\n⌔╽*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevAbs:del(ZOLARS..'Abs:ListRolet'..data.chat_id_) 
DevAbs:del(ZOLARS.."Abs:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevAbs:del(ZOLARS.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevAbs:sismember(ZOLARS..'Abs:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevAbs:sadd(ZOLARS..'Abs:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(ZOLARS..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
DevAbs:sadd(ZOLARS..'Abs:Muted:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔╽العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'zzzii')..')\n⌔╽تم كتمه من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:Muted:'..data.chat_id_,dp.id_)
...
DevAbs:sadd(ZOLARS..'Abs:Ban:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔╽العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'zzzii')..')\n⌔╽تم حظره من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(ZOLARS..'Abs:Ban:'..data.chat_id_,dp.id_)
...
DevAbs:sadd(ZOLARS..'Abs:Tkeed:'..data.chat_id_,dp.id_)
...
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..data.chat_id_,dp.id_)
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
DevAbs:srem(ZOLARS..'Abs:Manager:GpRedod'..data.chat_id_,Abbs)
end
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevAbs:get(ZOLARS..'Abs:Help')
local Text = [[
...
local Help = DevAbs:get(ZOLARS..'Abs:Help5')
local Text = [[
⌔╽اوامر المطورين ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌔╽الكروبات
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevAbs:get(ZOLARS..'Abs:Help6')
local Text = [[
⌔╽اوامر الاعضاء ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
...
if text and DevAbs:get(ZOLARS.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevAbs:get(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevAbs:del(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevAbs:del(ZOLARS.."Set:Cmd:Group:New"..msg.chat_id_)
DevAbs:srem(ZOLARS.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevAbs:del(ZOLARS.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevAbs:get(ZOLARS..'Abs:NameBot') or "زولارس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(ZOLARS..'Abs:NameBot') or "زولارس")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevAbs:get(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevAbs:get(ZOLARS.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevAbs:set(ZOLARS.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽ارسل الامر الجديد", 1, 'html')
DevAbs:del(ZOLARS.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevAbs:set(ZOLARS.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevAbs:get(ZOLARS.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevAbs:get(ZOLARS.."Set:Cmd:Group:New"..msg.chat_id_)
DevAbs:set(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevAbs:sadd(ZOLARS.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الامر", 1, 'html')
DevAbs:del(ZOLARS.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
...
DevAbs:sadd(ZOLARS.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevAbs:set(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevAbs:sadd(ZOLARS.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevAbs:set(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevAbs:sadd(ZOLARS.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevAbs:set(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevAbs:sadd(ZOLARS.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevAbs:set(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevAbs:sadd(ZOLARS.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevAbs:set(ZOLARS.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
...
DevAbs:set(ZOLARS.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevAbs:set(ZOLARS.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevAbs:sadd(ZOLARS.."Coomds"..msg.chat_id_,ComdNew)  
DevAbs:setex(ZOLARS.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n⌔╽ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevAbs:del(ZOLARS.."Comd:New:rt:Abs:"..ComdNew..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حذف الصلاحيه", 1, 'html')
end
if DevAbs:get(ZOLARS.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء الامر", 1, 'html')
DevAbs:del(ZOLARS.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevAbs:get(ZOLARS.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevAbs:set(ZOLARS.."Comd:New:rt:Abs:"..textn..msg.chat_id_,text)
...
if DevAbs:sismember(ZOLARS.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrabs = DevAbs:get(ZOLARS.."Comd:New:rt:Abs:"..DEV_ABBAS..msg.chat_id_)
...
DevAbs:set(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
DevAbs:sadd(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'zzzii')..')'..' ❩\n⌔╽تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAbs:set(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)
DevAbs:sadd(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrabs == "مدير" and Manager(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'zzzii')..')'..' ❩\n⌔╽تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAbs:set(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)  
DevAbs:sadd(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:srem(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAbs:del(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'zzzii')..')'..' ❩\n⌔╽تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAbs:del(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrabs == "مدير" and Manager(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'zzzii')..')'..' ❩\n⌔╽تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAbs:srem(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAbs:del(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrabs == "عضو" then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'zzzii')..')'..' ❩\n⌔╽تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
end
...
if DevAbs:sismember(ZOLARS.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrabs = DevAbs:get(ZOLARS.."Comd:New:rt:Abs:"..text1[2]..msg.chat_id_)
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'zzzii')..')'..' ❩\n⌔╽تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:sadd(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.id_)
DevAbs:set(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'zzzii')..')'..' ❩\n⌔╽تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:sadd(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.id_)
DevAbs:set(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrabs == "مدير" and Manager(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'zzzii')..')'..' ❩\n⌔╽تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:sadd(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.id_)
DevAbs:set(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrabs == "عضو" then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'zzzii')..')'..' ❩\n⌔╽تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAbs:srem(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.id_)
DevAbs:del(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'zzzii')..')'..' ❩\n⌔╽تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.id_)
DevAbs:del(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrabs == "مدير" and Manager(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'zzzii')..')'..' ❩\n⌔╽تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAbs:srem(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.id_)
DevAbs:del(ZOLARS.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrabs == "عضو" then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'zzzii')..')'..' ❩\n⌔╽تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAbs:incr(ZOLARS..'Abs:UsersMsgs'..ZOLARS..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:incr(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:incr(ZOLARS..'Abs:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevAbs:sismember(ZOLARS.."Abs:Users",msg.chat_id_) then
DevAbs:sadd(ZOLARS.."Abs:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔╽اهلا بك مجددا عزيزي المطور \n⌔╽اليك الازرار الخاصه بتعديل وتغيير كلايش سورس زولارس فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if not DevAbs:get(ZOLARS..'Abs:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=ZOLARS},function(arg,dp) 
local inline = {{{text="⌔ اضفني في مجموعتك ⌔",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
local start = DevAbs:get(ZOLARS.."Abs:Start:Bot")
if start then 
Start_Source = start
else
...
DevAbs:setex(ZOLARS..'Abs:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source ZOLARS     --
if not SecondSudo(msg) and not DevAbs:sismember(ZOLARS..'Abs:Ban:Pv',msg.sender_user_id_) and not DevAbs:get(ZOLARS..'Abs:Texting:Pv') then
...
DevAbs:sadd(ZOLARS..'Abs:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '⌔╽العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⌔╽تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevAbs:srem(ZOLARS..'Abs:Ban:Pv',data.id_)  
return false  
end 
...
--     Source ZOLARS     --
if text and DevAbs:get(ZOLARS..'Abs:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء حفظ كليشة الستارت', 1, 'md')
DevAbs:del(ZOLARS..'Abs:Start:Bots'..msg.sender_user_id_) 
return false
end
DevAbs:set(ZOLARS.."Abs:Start:Bot",text)  
...
DevAbs:set(ZOLARS..'Abs:Start:Bots'..msg.sender_user_id_,true) 
...
DevAbs:del(ZOLARS..'Abs:Texting:Pv') 
end
if text == 'تعطيل التواصل' or text == '↫ تعطيل التواصل ⌔' then  
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Texting:Pv',true) 
end
end
--     Source ZOLARS     --
...
DevAbs:incr(ZOLARS..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:set(ZOLARS.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevAbs:get(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevAbs:sadd(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevAbs:srem(ZOLARS.."Abs:Groups", msg.chat_id_) 
...
if DevAbs:get(ZOLARS..'Abs:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevAbs:incr(ZOLARS..'Abs:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevAbs:incr(ZOLARS..'Abs:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source ZOLARS     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevAbs:get(ZOLARS..'Abs:Lock:FreeBot'..ZOLARS) then
if ChatType == 'pv' then
...
DevAbs:sadd(ZOLARS..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevAbs:sadd(ZOLARS..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevAbs:sadd(ZOLARS.."Abs:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAbs:sadd(ZOLARS.."Abs:AbsConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAbs:srem(ZOLARS.."Abs:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAbs:srem(ZOLARS.."Abs:AbsConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevAbs:sismember(ZOLARS..'Abs:Groups',msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevAbs:get(ZOLARS..'Abs:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽عدد اعضاء المجموعه اقل من ↫ *'..(DevAbs:get(ZOLARS..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","⌔╽تم تفعيل المجموعه "..dp.title_)  
DevAbs:sadd(ZOLARS.."Abs:Groups",msg.chat_id_)
DevAbs:sadd(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevAbs:set(ZOLARS.."Abs:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevAbs:set(ZOLARS..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source ZOLARS     --
local ReFalse = tostring(msg.chat_id_)
if not DevAbs:sismember(ZOLARS.."Abs:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevAbs:get(ZOLARS..'Abs:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevAbs:sadd(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevAbs:get(ZOLARS.."Abs:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = DevAbs:smembers(ZOLARS.."Abs:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevAbs:get(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevAbs:srem(ZOLARS..'Abs:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevAbs:get(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevAbs:del(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevAbs:srem(ZOLARS..'Abs:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevAbs:get(ZOLARS..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevAbs:del(ZOLARS..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevAbs:srem(ZOLARS..'Abs:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevAbs:get(ZOLARS.."Abs:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevAbs:del(ZOLARS.."Abs:Add:AllRed"..msg.sender_user_id_)
DevAbs:del(ZOLARS.."Abs:Gif:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:Voice:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:Audio:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:Photo:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:Stecker:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:Video:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:File:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:Text:AllRed"..msg.content_.text_)
DevAbs:del(ZOLARS.."Abs:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source ZOLARS     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevAbs:get(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevAbs:srem(ZOLARS..'Abs:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
...
if text and not DevAbs:get(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevAbs:sismember(ZOLARS..'Abs:Manager:GpRedod'..msg.chat_id_,text) then
local ZOLARSTEAM =  DevAbs:smembers(ZOLARS..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..ZOLARSTEAM[math.random(#ZOLARSTEAM)]..']' , 1, 'md')  
end
end
--     Source ZOLARS     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevAbs:get(ZOLARS..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevAbs:get(ZOLARS..'DelManagerRep'..msg.chat_id_)
DevAbs:srem(ZOLARS..'Abs:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء حفظ الرد', 1, 'md')
DevAbs:del(ZOLARS..'Abs:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(ZOLARS..'DelManagerRep'..msg.chat_id_)
return false
end
DevAbs:del(ZOLARS..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevAbs:get(ZOLARS..'Abs:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevAbs:set(ZOLARS..'Abs:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevAbs:set(ZOLARS..'Abs:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevAbs:set(ZOLARS..'Abs:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevAbs:set(ZOLARS..'Abs:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevAbs:set(ZOLARS..'Abs:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevAbs:set(ZOLARS..'Abs:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevAbs:set(ZOLARS..'Abs:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevAbs:set(ZOLARS..'Abs:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevAbs:get(ZOLARS..'Abs:Lock:GpRed'..msg.chat_id_) then 
if DevAbs:get(ZOLARS..'Abs:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(ZOLARS..'Abs:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAbs:get(ZOLARS..'Abs:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(ZOLARS..'Abs:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAbs:get(ZOLARS..'Abs:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS..'Abs:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAbs:get(ZOLARS..'Abs:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS..'Abs:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAbs:get(ZOLARS..'Abs:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS..'Abs:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAbs:get(ZOLARS..'Abs:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS..'Abs:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAbs:get(ZOLARS..'Abs:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(ZOLARS..'Abs:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevAbs:get(ZOLARS..'Abs:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function ZOLARSTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevAbs:get(ZOLARS..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAbs:get(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevAbs:get(ZOLARS..'Abs:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, ZOLARSTEAM)
end
end
--     Source ZOLARS     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevAbs:get(ZOLARS.."Abs:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevAbs:get(ZOLARS..'DelSudoRep')
DevAbs:del(ZOLARS.."Abs:Sudo:AllRed",DelSudoRep)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء حفظ الرد', 1, 'md')
DevAbs:del(ZOLARS.."Abs:Add:AllText"..msg.sender_user_id_)
DevAbs:del(ZOLARS.."Abs:Add:AllRed"..msg.sender_user_id_)
DevAbs:del(ZOLARS.."DelSudoRep")
return false
end
DevAbs:del(ZOLARS.."Abs:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevAbs:get(ZOLARS.."Abs:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevAbs:set(ZOLARS.."Abs:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevAbs:set(ZOLARS.."Abs:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevAbs:set(ZOLARS.."Abs:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevAbs:set(ZOLARS.."Abs:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevAbs:set(ZOLARS.."Abs:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevAbs:set(ZOLARS.."Abs:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevAbs:set(ZOLARS.."Abs:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevAbs:set(ZOLARS.."Abs:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم حفظ الرد الجديد', 1, 'md') 
DevAbs:del(ZOLARS.."Abs:Add:AllText"..msg.sender_user_id_)
DevAbs:del(ZOLARS..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevAbs:get(ZOLARS..'Abs:Lock:AllRed'..msg.chat_id_) then
if DevAbs:get(ZOLARS.."Abs:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(ZOLARS.."Abs:Video:AllRed"..msg.content_.text_))
end
if DevAbs:get(ZOLARS.."Abs:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(ZOLARS.."Abs:File:AllRed"..msg.content_.text_))
end
if DevAbs:get(ZOLARS.."Abs:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS.."Abs:Voice:AllRed"..msg.content_.text_))
end
if DevAbs:get(ZOLARS.."Abs:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS.."Abs:Audio:AllRed"..msg.content_.text_))
end
if DevAbs:get(ZOLARS.."Abs:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS.."Abs:Photo:AllRed"..msg.content_.text_))
end
if  DevAbs:get(ZOLARS.."Abs:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevAbs:get(ZOLARS.."Abs:Gif:AllRed"..msg.content_.text_))
end
if DevAbs:get(ZOLARS.."Abs:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevAbs:get(ZOLARS.."Abs:Stecker:AllRed"..msg.content_.text_))
end
if DevAbs:get(ZOLARS.."Abs:Text:AllRed"..msg.content_.text_) then
function ZOLARSTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevAbs:get(ZOLARS..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAbs:get(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevAbs:get(ZOLARS.."Abs:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevAbs:sismember(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevAbs:sadd(ZOLARS..'Abs:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source ZOLARS     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= ZOLARS then
floods = DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevAbs:get(ZOLARS.."Abs:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevAbs:setex(ZOLARS.."Abs:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source ZOLARS     --
...
DevAbs:set(ZOLARS..'Abs:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevAbs:get(ZOLARS..'Abs:PinnedMsg'..msg.chat_id_)
if pin_id and DevAbs:get(ZOLARS..'Abs:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevAbs:get(ZOLARS..'Abs:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevAbs:del(ZOLARS..'Abs:viewget'..msg.sender_user_id_)
else
...
if DevAbs:get(ZOLARS..'Abs:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevAbs:get(ZOLARS..'Abs:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevAbs:get(ZOLARS..'Abs:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevAbs:get(ZOLARS..'Abs:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevAbs:get(ZOLARS..'Abs:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevAbs:get(ZOLARS..'Abs:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAbs:get(ZOLARS..'Abs:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevAbs:get(ZOLARS..'Abs:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAbs:get(ZOLARS..'Abs:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevAbs:get(ZOLARS..'Abs:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ZOLARS     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevAbs:get(ZOLARS..'Abs:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAbs:get(ZOLARS..'Abs:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevAbs:get(ZOLARS..'Abs:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if DevAbs:get(ZOLARS.."Abs:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source ZOLARS     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevAbs:get(ZOLARS..'Abs:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = ZOLARS,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(ZOLARS) then 
if DevAbs:sismember(ZOLARS..'Abs:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n⌔╽ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n⌔╽بعد ذلك يرجى ارسال امر ↫ تفعيل\n⌔╽سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevAbs:get(ZOLARS.."Abs:Text:BotWelcome") then AbsText = DevAbs:get(ZOLARS.."Abs:Text:BotWelcome") else AbsText = "⌔╽مرحبا انا بوت اسمي "..NameBot.."\n⌔╽حالة المجموعه ↫ "..BotText.."\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉" end 
if DevAbs:get(ZOLARS.."Abs:Photo:BotWelcome") then AbsPhoto = DevAbs:get(ZOLARS.."Abs:Photo:BotWelcome") elseif abbas.photos_[0] then AbsPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else AbsPhoto = nil end 
...
if DevAbs:get(ZOLARS..'Abs:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ZOLARS     --
...
if DevAbs:get(ZOLARS..'Abs:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAbs:get(ZOLARS..'Abs:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAbs:get(ZOLARS..'Abs:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevAbs:get(ZOLARS..'Abs:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not DevAbs:get(ZOLARS..'Abs:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevAbs:get(ZOLARS..'Abs:Spam:Text'..msg.chat_id_))
end
if DevAbs:get(ZOLARS..'Abs:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source ZOLARS     --
if DevAbs:get(ZOLARS.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"⌔╽تم الغاء حفظ الرابط")       
DevAbs:del(ZOLARS.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevAbs:set(ZOLARS.."Abs:Groups:Links"..msg.chat_id_,Link)
...
if DevAbs:get('ZOLARSTEAM:'..ZOLARS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('ZOLARSTEAM:'..ZOLARS..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء الامر', 1, 'md')
DevAbs:del('ZOLARSTEAM:'..ZOLARS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('ZOLARSTEAM:'..ZOLARS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('ZOLARSTEAM:'..ZOLARS..'id:user'..msg.chat_id_)  
DevAbs:incrby(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Abs(msg.chat_id_, msg.id_,  1, "⌔╽تم اضافة "..numadded..' رساله', 1, 'md')
DevAbs:del('ZOLARSTEAM:'..ZOLARS..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevAbs:get('ZOLARSTEAM:'..ZOLARS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('ZOLARSTEAM:'..ZOLARS..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء الامر', 1, 'md')
DevAbs:del('ZOLARSTEAM:'..ZOLARS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('ZOLARSTEAM:'..ZOLARS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('ZOLARSTEAM:'..ZOLARS..'ids:user'..msg.chat_id_)  
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevAbs:get(ZOLARS.."Abs:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevAbs:get(ZOLARS.."Abs:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevAbs:smembers(ZOLARS..'Abs:Groups') 
local BotName = (DevAbs:get(ZOLARS.."Abs:NameBot") or 'زولارس')
local GetJson = '{"BotId": '..ZOLARS..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevAbs:get(ZOLARS.."Abs:Groups:Links"..v)
Welcomes = DevAbs:get(ZOLARS..'Abs:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
AbsConstructors = DevAbs:smembers(ZOLARS..'Abs:AbsConstructor:'..v)
Constructors = DevAbs:smembers(ZOLARS..'Abs:BasicConstructor:'..v)
BasicConstructors = DevAbs:smembers(ZOLARS..'Abs:Constructor:'..v)
Managers = DevAbs:smembers(ZOLARS..'Abs:Managers:'..v)
Admis = DevAbs:smembers(ZOLARS..'Abs:Admins:'..v)
Vips = DevAbs:smembers(ZOLARS..'Abs:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
--     Source ZOLARS     --
if DevAbs:get(ZOLARS.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Abs( msg.chat_id_, msg.id_, 1,"⌔╽يوجد فقط ( 6 ) اختيارات\n⌔╽ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevAbs:get(ZOLARS.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevAbs:del(ZOLARS.."SET:GAME"..msg.chat_id_)   
Dev_Abs( msg.chat_id_, msg.id_, 1,'⌔╽*المحيبس باليد رقم* ↫ '..NUM..'\n⌔╽*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevAbs:get(ZOLARS..'DevAbs4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "⌔╽تم الغاء الامر")
DevAbs:del(ZOLARS..'DevAbs4'..msg.sender_user_id_)
return false  end 
DevAbs:del(ZOLARS..'DevAbs4'..msg.sender_user_id_)
...
DevAbs:set(ZOLARS..'Abs:ChId',data.id_)
else
...
--     Source ZOLARS     --
if DevAbs:get(ZOLARS.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevAbs:del(ZOLARS.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء الامر', 1, 'md')
return false 
end 
DevAbs:del(ZOLARS.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevAbs:set(ZOLARS.."DevText", DevText)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ كليشة المطور", 1, "md")
end
if DevAbs:get(ZOLARS..'Abs:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevAbs:del(ZOLARS..'Abs:NameBot'..msg.sender_user_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم حفظ اسم البوت ', 1, 'html')
DevAbs:del(ZOLARS..'Abs:NameBot'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:NameBot', text)
return false 
end
--     Source ZOLARS     --
if text == "الرابط" then
if not DevAbs:get(ZOLARS.."Abs:Lock:GpLinks"..msg.chat_id_) then 
if DevAbs:get(ZOLARS.."Abs:Groups:Links"..msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽𝒈𝒓𝒐𝒖𝒑 𝒍𝒊𝒏𝒌 ↬ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"..DevAbs:get(ZOLARS.."Abs:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'زولارس')
local ZOLARSTEAM = {"لتكول بوت اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM[math.random(#ZOLARSTEAM)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'زولارس') 
local ZOLARSTEAM = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM[math.random(#ZOLARSTEAM)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(ZOLARS..'Abs:NameBot') or 'زولارس') then 
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'زولارس')
local ZOLARSTEAM = {'😸♥️ هلا كلبي وياك '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM[math.random(#ZOLARSTEAM)] , 1, 'html') 
return false 
end
if text =='نقاطي' and ChCheck(msg) then 
if tonumber((DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽لم تربح اي نقطه\n⌔╽ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽عدد النقاط التي ربحتها ↫ '..(DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbs:del(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbs:del(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم حذف جميع نقاطك', 1, 'md') end
--     Source ZOLARS     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) then
if not DevAbs:get(ZOLARS..'Abs:Lock:Games'..msg.chat_id_) then
DevAbs2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
ZOLARSTEAM = '⌔╽اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
ZOLARSTEAM = '⌔╽مبروك لقد ربحت في اللعبه \n⌔╽ارسل ↫ سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevAbs:set(ZOLARS..'Abs:Games:Ids'..msg.chat_id_,true)
end
...
if not DevAbs:get(ZOLARS..'Abs:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevAbs:set(ZOLARS.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevAbs:setex(ZOLARS.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
ZOLARSTEAM = '⌔╽اول واحد يحلها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum2'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
...
ZOLARSTEAM = '⌔╽ما معنى هذا السمايل :؟ ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum2'..msg.chat_id_) and not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum3'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
...
ZOLARSTEAM = '⌔╽ما هو عكس كلمة ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum3'..msg.chat_id_) and not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
...
DevAbs2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum4'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
ZOLARSTEAM = '⌔╽اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum4'..msg.chat_id_) and not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum5'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
...
ZOLARSTEAM = '⌔╽اكمل المثال التالي ↫ ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum5'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(ZOLARS..'Abs:GameNum5'..msg.chat_id_)
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum6'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
...
ZOLARSTEAM = '⌔╽اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum6'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(ZOLARS..'Abs:GameNum6'..msg.chat_id_)
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum7'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
...
ZOLARSTEAM = '⌔╽ما معنى كلمة ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(ZOLARS..'Abs:GameNum7'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(ZOLARS..'Abs:GameNum7'..msg.chat_id_)
...
name = DevAbs2[math.random(#DevAbs2)]
DevAbs:set(ZOLARS..'Abs:GameNum8'..msg.chat_id_,name)
DevAbs:del(ZOLARS..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevAbs:get(ZOLARS..'Abs:GameNum8'..msg.chat_id_) then
if not DevAbs:get(ZOLARS..'Abs:Games:Ids'..msg.chat_id_) then 
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAbs:del(ZOLARS..'Abs:GameNum8'..msg.chat_id_)
...
--     Source ZOLARS     --
if DevAbs:get(ZOLARS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Abs(msg.chat_id_, msg.id_, 1,"⌔╽عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevAbs:get(ZOLARS.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevAbs:del(ZOLARS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAbs:del(ZOLARS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽*التخمين الصحيح هو* ↫ '..NUM..'\n⌔╽*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevAbs:incrby(ZOLARS..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevAbs:get(ZOLARS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevAbs:del(ZOLARS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAbs:del(ZOLARS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽*التخمين الصحيح هو* ↫ '..GETNUM..'\n⌔╽*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevAbs:get(ZOLARS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevAbs:get(ZOLARS..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevAbs:set(ZOLARS.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n⌔╽سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n⌔╽ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevAbs:setex(ZOLARS.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source ZOLARS     --
if text == 'روليت' then
if not DevAbs:get(ZOLARS..'Abs:Lock:Games'..msg.chat_id_) then
DevAbs:del(ZOLARS.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAbs:del(ZOLARS..'Abs:ListRolet'..msg.chat_id_)  
DevAbs:setex(ZOLARS.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevAbs:get(ZOLARS.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "⌔╽لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevAbs:set(ZOLARS.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '⌔╽تم بدء تسجيل اللسته يرجى ارسال المعرفات \n⌔╽الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevAbs:del(ZOLARS.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevAbs:get(ZOLARS.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevAbs:sismember(ZOLARS..'Abs:ListRolet'..msg.chat_id_,text) then
...
DevAbs:sadd(ZOLARS..'Abs:ListRolet'..msg.chat_id_,text)
local CountAdd = DevAbs:get(ZOLARS.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevAbs:scard(ZOLARS..'Abs:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevAbs:del(ZOLARS.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAbs:setex(ZOLARS.."Abs:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
if not DevAbs:get(ZOLARS..'Abs:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}},
}
...
DevAbs0 = (DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevAbs:incrby(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevAbs0)
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽تم بيع '..(DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n⌔╽كل نقطه تساوي 50 رساله', 'md')
DevAbs:del(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source ZOLARS     --
...
DevAbs:sadd(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevAbs:sadd(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevAbs:get(ZOLARS.."Abs:Left:Bot"..ZOLARS) and not SecondSudo(msg) then
...
DevAbs:setex(ZOLARS..'DevAbs4'..msg.sender_user_id_,360,true)
...
function ZOLARSTEAM(extra,result,success)
if DevAbs:get(ZOLARS.."Abs:Send:Bot"..ZOLARS) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"⌔╽الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevAbs:smembers(ZOLARS.."Abs:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevAbs:smembers(ZOLARS.."Abs:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم اذاعة رسالتك بالتوجيه \n⌔╽‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n⌔╽والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),ZOLARSTEAM)
end
end
--     Source ZOLARS     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevAbs:set(ZOLARS..'Abs:viewget'..msg.sender_user_id_,true)
...
if DevAbs:get(ZOLARS.."Abs:Kick:Me"..msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevAbs:set(ZOLARS..'yes'..msg.sender_user_id_, 'delyes')
DevAbs:set(ZOLARS..'no'..msg.sender_user_id_, 'delno')
...
DevAbs:set(ZOLARS.."Abs:Kick:Me"..msg.chat_id_, true)
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل امر اطردني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevAbs:del(ZOLARS.."Abs:Kick:Me"..msg.chat_id_)
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل امر اطردني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source ZOLARS     --
if text == "نزلني" and ChCheck(msg) then
if DevAbs:get(ZOLARS.."Abs:Del:Me"..msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevAbs:set(ZOLARS..'yesdel'..msg.sender_user_id_, 'delyes')
DevAbs:set(ZOLARS..'nodel'..msg.sender_user_id_, 'delno')
...
DevAbs:set(ZOLARS.."Abs:Del:Me"..msg.chat_id_, true)
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل امر نزلني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevAbs:del(ZOLARS.."Abs:Del:Me"..msg.chat_id_)
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل امر نزلني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source ZOLARS     --
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:TagAll'..msg.chat_id_)
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevAbs:get(ZOLARS..'Abs:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "⌔╽وينكم يالربع \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevAbs:get(ZOLARS..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevAbs:get(ZOLARS..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevAbs:get(ZOLARS..'Abs:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevAbs:get(ZOLARS..'Abs:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevAbs:get(ZOLARS..'Abs:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAbs:get(ZOLARS..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbs:del(ZOLARS..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
...
if DevAbs:get(ZOLARS.."Abs:ChId") then local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevAbs:get(ZOLARS.."Abs:ChId")) local GetInfo = JSON.decode(Check) local DevCh1 = GetInfo.result.username DevCh = '\n⌔╽*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
...
Text = "• *The developer and programmer of this source is* : [Abbas Kareem](https://t.me/sSs_sSs)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='- AbBaS KArEeM .',url="t.me/sSs_sSs"}}}
local msg_id = msg.id_/2097152/0.5
...
if DevAbs:sismember(ZOLARS.."Abs:AbsConstructor:"..msg.chat_id_,result.id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ZOLARSTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md') 
local ZOLARSTEAM = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..ZOLARSTEAM[math.random(#ZOLARSTEAM)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,ZOLARSTEAM)
end
end
--     Source ZOLARS     --
...
if DevAbs:sismember(ZOLARS.."Abs:AbsConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ZOLARSTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md') 
local ZOLARSTEAM = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
...
local ZOLARSTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md') 
local ZOLARSTEAM = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..ZOLARSTEAM[math.random(#ZOLARSTEAM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local ZOLARSTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md') 
local ZOLARSTEAM = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..ZOLARSTEAM[math.random(#ZOLARSTEAM)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevAbs:sismember(ZOLARS..'Abs:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAbs:sismember(ZOLARS..'Abs:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(ZOLARS..'Abs:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(ZOLARS..'Abs:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(ZOLARS..'Abs:VipAll:',result.sender_user_id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevAbs:sismember(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAbs:sismember(ZOLARS..'Abs:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAbs:sismember(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevAbs:sismember(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAbs:sismember(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAbs:sismember(ZOLARS..'Abs:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevAbs:srem(ZOLARS..'Abs:SecondSudo:', result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:SudoBot:', result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:ManagerAll:', result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:AdminAll:', result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:VipAll:', result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevAbs:sismember(ZOLARS..'Abs:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAbs:sismember(ZOLARS..'Abs:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(ZOLARS..'Abs:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(ZOLARS..'Abs:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(ZOLARS..'Abs:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevAbs:sismember(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAbs:sismember(ZOLARS..'Abs:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAbs:sismember(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevAbs:sismember(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAbs:sismember(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAbs:sismember(ZOLARS..'Abs:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if AbsDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevAbs:srem(ZOLARS..'Abs:SecondSudo:', result.id_)
DevAbs:srem(ZOLARS..'Abs:SudoBot:', result.id_)
DevAbs:srem(ZOLARS..'Abs:ManagerAll:', result.id_)
DevAbs:srem(ZOLARS..'Abs:AdminAll:', result.id_)
DevAbs:srem(ZOLARS..'Abs:VipAll:', result.id_)
DevAbs:srem(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,result.id_)
DevAbs:srem(ZOLARS..'Abs:Constructor:'..msg.chat_id_,result.id_)
DevAbs:srem(ZOLARS..'Abs:Managers:'..msg.chat_id_, result.id_)
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_, result.id_)
DevAbs:srem(ZOLARS..'Abs:VipMem:'..msg.chat_id_, result.id_)
DevAbs:srem(ZOLARS..'Abs:Cleaner:'..msg.chat_id_, result.id_)
elseif AbsDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudo' then
DevAbs:srem(ZOLARS..'Abs:SudoBot:', result.id_)
DevAbs:srem(ZOLARS..'Abs:ManagerAll:', result.id_)
DevAbs:srem(ZOLARS..'Abs:AdminAll:', result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:SecondSudo:',result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:SecondSudo:',result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:SecondSudo:',user)
...
DevAbs:srem(ZOLARS..'Abs:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevAbs:sadd(ZOLARS..'Abs:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:SudoBot:',result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:SudoBot:',user)
...
DevAbs:srem(ZOLARS..'Abs:SudoBot:',user)
...
DevAbs:sadd(ZOLARS..'Abs:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:ManagerAll:',result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:ManagerAll:',user)
...
DevAbs:srem(ZOLARS..'Abs:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(ZOLARS..'Abs:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:AdminAll:',result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:AdminAll:',user)
...
DevAbs:srem(ZOLARS..'Abs:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(ZOLARS..'Abs:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:VipAll:',result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:VipAll:',user)
...
DevAbs:srem(ZOLARS..'Abs:VipAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,user)
...
DevAbs:srem(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevAbs:srem(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,result.id_)
...
DevAbs:srem(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,user)
...
DevAbs:srem(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(ZOLARS..'Abs:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:Constructor:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:Constructor:'..msg.chat_id_,user)
...
DevAbs:srem(ZOLARS..'Abs:Constructor:'..msg.chat_id_,user)
...
DevAbs:sadd(ZOLARS..'Abs:Managers:'..msg.chat_id_,user)
...
DevAbs:srem(ZOLARS..'Abs:Managers:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
DevAbs:sadd(ZOLARS..'Abs:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:Cleaner:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:Cleaner:'..msg.chat_id_,user)
...
DevAbs:srem(ZOLARS..'Abs:Cleaner:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevAbs:get(ZOLARS.."Abs:Lock:ProSet"..msg.chat_id_) then 
...
DevAbs:sadd(ZOLARS..'Abs:Admins:'..msg.chat_id_,user)
...
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_,user)
...
DevAbs:sadd(ZOLARS..'Abs:VipMem:'..msg.chat_id_,user)
...
DevAbs:srem(ZOLARS..'Abs:VipMem:'..msg.chat_id_,user)
...
local Text = '⌔╽قم باستعمال الازرار لرفع العضو ↫ ⤈\n⌔╽العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'zzzii')..')'
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif AbsConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif BasicConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Constructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Manager(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
end
...
local Text = '⌔╽قم باستعمال الازرار لتنزيل العضو ↫ ⤈\n⌔╽العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'zzzii')..')'
if Sudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="تنزيل مطور ثانوي",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif SecondSudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif SudoBot(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif AbsConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif BasicConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Constructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Manager(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
elseif Admin(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text = '⌔ ZOLARS TeAM .',url="t.me/zzzii"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == "راسلني" then
ZOLARSTEAM = {"ها هلاو","انطق","كول حبي","تفضل"};
send(msg.sender_user_id_, 0,ZOLARSTEAM[math.random(#ZOLARSTEAM)])
end
--     Source ZOLARS     --
...
DevAbs:del(ZOLARS.."Abs:Lock:ProSet"..msg.chat_id_)
...
DevAbs:set(ZOLARS.."Abs:Lock:ProSet"..msg.chat_id_,"true")
...
if not Constructor(msg) and DevAbs:get(ZOLARS.."Abs:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevAbs:sadd(ZOLARS..'Abs:Ban:'..msg.chat_id_, result.sender_user_id_)
...
ChatKick(msg.chat_id_, result.id_)
DevAbs:sadd(ZOLARS..'Abs:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevAbs:sadd(ZOLARS..'Abs:Ban:'..msg.chat_id_, user)
...
DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_, result.id_)
...
DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_, user)
...
if not Constructor(msg) and DevAbs:get(ZOLARS.."Abs:Lock:MuteTked"..msg.chat_id_) then 
...
if DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌔╽هو بالفعل مكتوم من المجموعه")  
else
DevAbs:sadd(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌔╽هو بالفعل مكتوم من المجموعه")  
else
DevAbs:sadd(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.id_)
...
if DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌔╽هو بالفعل مكتوم من المجموعه")  
else
DevAbs:sadd(ZOLARS..'Abs:Muted:'..msg.chat_id_, user)
...
if not DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌔╽هو ليس مكتوم لالغاء كتمه")  
else
DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌔╽هو ليس مكتوم لالغاء كتمه")  
else
DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_, result.id_)
...
if not DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌔╽هو ليس مكتوم لالغاء كتمه")  
else
DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_, user)
...
DevAbs:sadd(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:sadd(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, user)
...
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, result.id_)
...
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, user)
...
if DevAbs:sismember(ZOLARS..'Abs:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevAbs:sadd(ZOLARS..'Abs:BanAll:', result.sender_user_id_)
...
if DevAbs:sismember(ZOLARS..'Abs:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevAbs:sadd(ZOLARS..'Abs:BanAll:', result.id_)
...
if DevAbs:sismember(ZOLARS..'Abs:SecondSudo:',user) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevAbs:sadd(ZOLARS..'Abs:BanAll:', user)
...
DevAbs:sadd(ZOLARS..'Abs:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:MuteAll:', result.id_)
...
DevAbs:sadd(ZOLARS..'Abs:MuteAll:', user)
...
DevAbs:srem(ZOLARS..'Abs:BanAll:', result.sender_user_id_)
DevAbs:srem(ZOLARS..'Abs:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevAbs:srem(ZOLARS..'Abs:BanAll:', result.id_)
DevAbs:srem(ZOLARS..'Abs:MuteAll:', result.id_)
...
DevAbs:srem(ZOLARS..'Abs:BanAll:', user)
DevAbs:srem(ZOLARS..'Abs:MuteAll:', user)
...
DevAbs:setex(ZOLARS.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if DevAbs:get(ZOLARS.."Abs:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'⌔╽تم الغاء امر تغير المطور الاساسي')
DevAbs:del(ZOLARS.."Abs:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevAbs:del(ZOLARS.."Abs:EditDev"..msg.sender_user_id_)
DevAbs:set(ZOLARS.."Abs:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source ZOLARS     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevAbs:get(ZOLARS..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevAbs:sismember(ZOLARS..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌔╽هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","⌔╽تم رفعه في قائمة المطايه") 
DevAbs:sadd(ZOLARS..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source ZOLARS     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevAbs:get(ZOLARS..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevAbs:sismember(ZOLARS..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌔╽هو ليس مطي ليتم تنزيله") 
else
DevAbs:srem(ZOLARS..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevAbs:set('ZOLARSTEAM:'..ZOLARS..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('ZOLARSTEAM:'..ZOLARS.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:del(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevAbs:incrby(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevAbs:set('ZOLARSTEAM:'..ZOLARS..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('ZOLARSTEAM:'..ZOLARS.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevAbs:incrby(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevAbs:get(ZOLARS..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(ZOLARS.."Abs:cleaner"..msg.chat_id_, msg.id_) else DevAbs:sadd(ZOLARS.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevAbs:sismember(ZOLARS.."Abs:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevAbs:set(ZOLARS..'Abs:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevAbs:smembers(ZOLARS..'Abs:VipMem:'..msg.chat_id_)
text = "⌔╽قائمة المميزين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..abs)
text = "⌔╽قائمة الادمنيه ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..'Abs:Managers:'..msg.chat_id_)
text = "⌔╽قائمة المدراء ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..'Abs:Cleaner:'..msg.chat_id_)
text = "⌔╽قائمة المنظفين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..'Abs:Constructor:'..msg.chat_id_)
text = "⌔╽قائمة المنشئين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_)
text = "⌔╽قائمة المالكين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_)
...
local List = DevAbs:smembers(ZOLARS..'Abs:Muted:'..msg.chat_id_)
...
local List = DevAbs:smembers(ZOLARS..'Abs:Tkeed:'..msg.chat_id_)
text = "⌔╽قائمة المقيدين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..'Abs:Ban:'..msg.chat_id_)
...
local List = DevAbs:hkeys(ZOLARS..'Abs:Filters:'..msg.chat_id_)
text = "⌔╽قائمة المنع ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevAbs:smembers(ZOLARS..'User:Donky:'..msg.chat_id_)
...
local List = DevAbs:smembers(ZOLARS..'Abs:SecondSudo:')
...
local BanAll = DevAbs:smembers(ZOLARS..'Abs:BanAll:')
local MuteAll = DevAbs:smembers(ZOLARS..'Abs:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevAbs:smembers(ZOLARS..'Abs:SudoBot:')
text = "⌔╽قائمة المطورين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local sudouser = DevAbs:get(ZOLARS..'Abs:Sudos'..v) 
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(ZOLARS..'Abs:ManagerAll:')
...
local List = DevAbs:smembers(ZOLARS..'Abs:VipAll:')
...
DevAbs:sadd(ZOLARS.."Abs:AbsConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
DevAbs:sadd(ZOLARS.."Abs:FilterSteckr"..msg.chat_id_,idsticker)
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevAbs:srem(ZOLARS.."Abs:FilterSteckr"..msg.chat_id_,idsticker)
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Thwel:Abs'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل تحويل الصيغ'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Thwel:Abs'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevAbs:get(ZOLARS..'Abs:Thwel:Abs'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevAbs:get(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevAbs:sismember(ZOLARS..'Abs:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevAbs:sismember(ZOLARS..'Abs:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevAbs:sismember(ZOLARS..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevAbs:sismember(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAbs:sismember(ZOLARS..'Abs:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n⌔╽عدد الكروبات ↫ '..(DevAbs:get(ZOLARS..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAbs:get(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevAbs:sismember(ZOLARS..'Abs:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevAbs:sismember(ZOLARS..'Abs:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevAbs:sismember(ZOLARS..'Abs:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevAbs:sismember(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAbs:sismember(ZOLARS..'Abs:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n⌔╽عدد الكروبات ↫ '..(DevAbs:get(ZOLARS..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAbs:get(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevAbs:sismember(ZOLARS..'Abs:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevAbs:sismember(ZOLARS..'Abs:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevAbs:sismember(ZOLARS..'Abs:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevAbs:sismember(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAbs:sismember(ZOLARS..'Abs:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n⌔╽عدد الكروبات ↫ '..(DevAbs:get(ZOLARS..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAbs:sismember(ZOLARS..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAbs:sismember(ZOLARS..'Abs:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAbs:sismember(ZOLARS..'Abs:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAbs:sismember(ZOLARS..'Abs:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevAbs:sismember(ZOLARS..'Abs:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAbs:sismember(ZOLARS..'Abs:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAbs:sismember(ZOLARS..'Abs:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAbs:sismember(ZOLARS..'Abs:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAbs:sismember(ZOLARS..'Abs:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽الحظر العام ↫ '..banall..'\n⌔╽الكتم العام ↫ '..muteall..'\n⌔╽الحظر ↫ '..banned..'\n⌔╽الكتم ↫ '..muted..'\n⌔╽التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(ZOLARS..'Abs:BanAll:',result.sender_user_id_) DevAbs:srem(ZOLARS..'Abs:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,user) DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_,user) DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_,user) DevAbs:srem(ZOLARS..'Abs:BanAll:',user) DevAbs:srem(ZOLARS..'Abs:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,user) DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_,user) DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,result.id_) DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_,result.id_) DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_,result.id_) DevAbs:srem(ZOLARS..'Abs:BanAll:',result.id_) DevAbs:srem(ZOLARS..'Abs:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_,result.id_) DevAbs:srem(ZOLARS..'Abs:Ban:'..msg.chat_id_,result.id_) DevAbs:srem(ZOLARS..'Abs:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevAbs:set(ZOLARS.."Abs:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevAbs:set("ZOLARS:New:id:"..ZOLARS..msg.sender_user_id_,'ZOLARSTEAM')
return "ZOLARSTEAM"
end
if text and DevAbs:get("ZOLARS:New:id:"..ZOLARS..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAbs:del("ZOLARS:New:id:"..ZOLARS..msg.sender_user_id_)
return false
end
DevAbs:del("ZOLARS:New:id:"..ZOLARS..msg.sender_user_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم حفظ كليشة الايدي العامه', 1, 'md')
DevAbs:set(ZOLARS.."Abs:AllIds:Text",text)
return false
end
...
DevAbs:del(ZOLARS.."Abs:AllIds:Text")
end
end
--     Source ZOLARS     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽رجائا اتبع التعليمات للتعيين \n⌔╽لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevAbs:set("ZOLARS:New:id:"..ZOLARS..msg.chat_id_..msg.sender_user_id_,'ZOLARSTEAM')
return "ZOLARSTEAM"
end
if text and Manager(msg) and DevAbs:get("ZOLARS:New:id:"..ZOLARS..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAbs:del("ZOLARS:New:id:"..ZOLARS..msg.chat_id_..msg.sender_user_id_)
return false
end
DevAbs:del("ZOLARS:New:id:"..ZOLARS..msg.chat_id_..msg.sender_user_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم حفظ الكليشه الجديده', 1, 'md')
DevAbs:set(ZOLARS.."Abs:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم حذف كليشة الايدي")  
DevAbs:del(ZOLARS.."Abs:GpIds:Text"..msg.chat_id_)
end
end
--     Source ZOLARS     --
if msg.reply_to_message_id_ ~= 0 then
...
function ZOLARSTEAM(extra,abbas,success)
...
local msgsday = DevAbs:get(ZOLARS..'Abs:UsersMsgs'..ZOLARS..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevAbs:get(ZOLARS..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAbs:get(ZOLARS..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevAbs:get(ZOLARS..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevAbs:get(ZOLARS..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if DevAbs:get(ZOLARS.."Abs:AllIds:Text") then
newpicid = DevAbs:get(ZOLARS.."Abs:AllIds:Text")
...
if not DevAbs:get(ZOLARS.."Abs:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, abbas.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevAbs:get(ZOLARS.."Abs:GpIds:Text"..msg.chat_id_)
...
if DevAbs:get(ZOLARS.."Abs:AllIds:Text") then
newallid = DevAbs:get(ZOLARS.."Abs:AllIds:Text")
...
if DevAbs:get(ZOLARS.."Abs:AllIds:Text") then
notpicid = DevAbs:get(ZOLARS.."Abs:AllIds:Text")
...
if not DevAbs:get(ZOLARS..'Abs:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل التعديل")  
DevAbs:set(ZOLARS..'Abs:Lock:EditMsgs'..msg.chat_id_,true)
else
...
if DevAbs:get(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل الفشار")  
DevAbs:del(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_)
else
...
if DevAbs:get(ZOLARS..'Abs:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل الكفر")  
DevAbs:del(ZOLARS..'Abs:Lock:Kfr'..msg.chat_id_)
else
...
DevAbs:set(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevAbs:get(ZOLARS..'Abs:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevAbs:set(ZOLARS.."Abs:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل التثبيت")  
DevAbs:set(ZOLARS..'Abs:Lock:Pin'..msg.chat_id_,true)
DevAbs:sadd(ZOLARS.."Abs:Lock:Pinpin",msg.chat_id_) 
else
...
DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevAbs:get(ZOLARS..'Abs:Lock:Id'..msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽الايدي بالتاكيد معطل ', 1, 'md')
else
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل الايدي بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source ZOLARS     --
...
DevAbs:setex(ZOLARS.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' or text == 'انشاء الرابط' then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevAbs:get(ZOLARS.."Abs:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevAbs:set(ZOLARS.."Abs:Groups:Links"..msg.chat_id_,LinkGroup) 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS.."Abs:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل الترحيب بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS.."Abs:Lock:Welcome"..msg.chat_id_)
end
if DevAbs:get(ZOLARS..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevAbs:del(ZOLARS..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbs:del(ZOLARS..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevAbs:set(ZOLARS..'Abs:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevAbs:set(ZOLARS..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم حذف الترحيب")  
DevAbs:del(ZOLARS..'Abs:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevAbs:get(ZOLARS..'Abs:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source ZOLARS     --
if DevAbs:get(ZOLARS..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء حفظ الوصف", 1, 'md')
DevAbs:del(ZOLARS..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbs:del(ZOLARS..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevAbs:set(ZOLARS..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevAbs:set(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevAbs:get(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء امر المنع', 1, 'md')
DevAbs:del(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم منع الكلمه ↫ "..text, 1, 'html')
DevAbs:del(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevAbs:hset(ZOLARS..'Abs:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽ارسل لي الكلمه الان", 1, 'md') 
DevAbs:set(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevAbs:get(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء امر الغاء المنع', 1, 'md')
DevAbs:del(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevAbs:hget(ZOLARS..'Abs:Filters:'..msg.chat_id_, text) then  
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevAbs:del(ZOLARS.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevAbs:hdel(ZOLARS..'Abs:Filters:'..msg.chat_id_, text)
...
local gps = DevAbs:scard(ZOLARS.."Abs:Groups") local users = DevAbs:scard(ZOLARS.."Abs:Users") 
...
local users = DevAbs:scard(ZOLARS.."Abs:Users")
...
local gps = DevAbs:scard(ZOLARS.."Abs:Groups")
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
end
--     Source ZOLARS     --
if text and text:match('^تنظيف (%d+)$') and ChCheck(msg) then  
if not DevAbs:get(ZOLARS..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevAbs:setex(ZOLARS..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
if text == "تنظيف المشتركين" and SecondSudo(msg) and ChCheck(msg) then 
local pv = DevAbs:smembers(ZOLARS.."Abs:Users")
local sendok = 0
for i = 1, #pv do
...
DevAbs:srem(ZOLARS.."Abs:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevAbs:smembers(ZOLARS.."Abs:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevAbs:srem(ZOLARS.."Abs:Groups",group[i]) 
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔╽عدد الكروبات الان ↫ { '..#group..' }'..ZOLARSgp1..ZOLARSgp2..'\n⌔╽العدد الحقيقي الان  ↫ ( '..ZOLARSgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:Clean'..msg.chat_id_,true)  
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:Clean'..msg.chat_id_) 
end
...
DevAbs:set(ZOLARS..'Abs:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevAbs:get(ZOLARS..'Abs:Lock:Clean'..msg.chat_id_) then
if DevAbs:get(ZOLARS..'Abs:CleanNum'..msg.chat_id_) then CleanNum = DevAbs:get(ZOLARS..'Abs:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevAbs:scard(ZOLARS.."Abs:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevAbs:smembers(ZOLARS.."Abs:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
DevAbs:del(ZOLARS.."Abs:cleaner"..msg.chat_id_)
end 
end 
if Cleaner(msg) then
if DevAbs:get(ZOLARS..'Abs:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevAbs:scard(ZOLARS.."Abs:cleaner"..msg.chat_id_)
if M ~= 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽عدد الميديا ↫ "..M.."\n⌔╽الحذف التلقائي ↫ "..(DevAbs:get(ZOLARS..'Abs:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
if DevAbs:get(ZOLARS..'Abs:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم فتح التعديل")  
DevAbs:del(ZOLARS..'Abs:Lock:EditMsgs'..msg.chat_id_)
else
...
if not DevAbs:get(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم فتح الفشار")  
DevAbs:set(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_,true)
else
...
if not DevAbs:get(ZOLARS..'Abs:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم فتح الكفر")  
DevAbs:set(ZOLARS..'Abs:Lock:Kfr'..msg.chat_id_,true)
else
...
DevAbs:del(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
DevAbs:hdel(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevAbs:get(ZOLARS..'Abs:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم فتح التثبيت")  
DevAbs:del(ZOLARS..'Abs:Lock:Pin'..msg.chat_id_)
DevAbs:srem(ZOLARS.."Abs:Lock:Pinpin",msg.chat_id_)
else
...
if not DevAbs:get(ZOLARS..'Abs:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل الاونلاين")  
DevAbs:set(ZOLARS..'Abs:Lock:Inline'..msg.chat_id_,true)
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽الاونلاين بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الصور" then
if not DevAbs:get(ZOLARS..'Abs:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل الصور")  
DevAbs:set(ZOLARS..'Abs:Lock:Photo'..msg.chat_id_,true)
else
...
if not DevAbs:get(ZOLARS..'Abs:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل الدخول")  
DevAbs:set(ZOLARS..'Abs:Lock:Join'..msg.chat_id_,true)
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽الدخول بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفيديو" then
if not DevAbs:get(ZOLARS..'Abs:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم قفل الفيديو")  
DevAbs:set(ZOLARS..'Abs:Lock:Videos'..msg.chat_id_,true)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Photo'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Join'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Videos'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Document'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Inline'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Markdown'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Music'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Voice'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Links'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Location'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Tags'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Hashtak'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Contact'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:WebLinks'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:English'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:TagServr'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Stickers'..msg.chat_id_)
else
...
DevAbs:del(ZOLARS..'Abs:Lock:Forwards'..msg.chat_id_)
else
...
DevAbs:set(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_,"del") DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Abs:Lock:Links','Abs:Lock:Contact','Abs:Lock:Forwards','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:EditMsgs','Abs:Lock:Stickers','Abs:Lock:Farsi','Abs:Lock:Spam','Abs:Lock:WebLinks','Abs:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevAbs:set(ZOLARS..Lock..msg.chat_id_,true)
end
...
DevAbs:del(ZOLARS..UnLock..msg.chat_id_)
end
...
DevAbs:del(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_) DevAbs:del(ZOLARS..'Abs:Lock:Taf'..msg.chat_id_) DevAbs:del(ZOLARS..'Abs:Lock:Kfr'..msg.chat_id_) 
DevAbs:set(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_,"del") DevAbs:hset(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Abs:Lock:EditMsgs','Abs:Lock:Farsi','Abs:Lock:TagServr','Abs:Lock:Inline','Abs:Lock:Photo','Abs:Lock:Spam','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:Music','Abs:Lock:Voice','Abs:Lock:Links','Abs:Lock:Location','Abs:Lock:Tags','Abs:Lock:Stickers','Abs:Lock:Markdown','Abs:Lock:Forwards','Abs:Lock:Document','Abs:Lock:Contact','Abs:Lock:Hashtak','Abs:Lock:WebLinks'}
for i,Lock in pairs(LockList) do
DevAbs:set(ZOLARS..Lock..msg.chat_id_,true)
...
DevAbs:set(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_,true) DevAbs:set(ZOLARS..'Abs:Lock:Taf'..msg.chat_id_,true) DevAbs:set(ZOLARS..'Abs:Lock:Kfr'..msg.chat_id_,true) DevAbs:hdel(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
UnLockList ={'Abs:Lock:EditMsgs','Abs:Lock:Text','Abs:Lock:Arabic','Abs:Lock:English','Abs:Lock:Join','Abs:Lock:Bots','Abs:Lock:Farsi','Abs:Lock:FarsiBan','Abs:Lock:TagServr','Abs:Lock:Inline','Abs:Lock:Photo','Abs:Lock:Spam','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:Music','Abs:Lock:Voice','Abs:Lock:Links','Abs:Lock:Location','Abs:Lock:Tags','Abs:Lock:Stickers','Abs:Lock:Markdown','Abs:Lock:Forwards','Abs:Lock:Document','Abs:Lock:Contact','Abs:Lock:Hashtak','Abs:Lock:WebLinks'}
for i,UnLock in pairs(UnLockList) do
DevAbs:del(ZOLARS..UnLock..msg.chat_id_)
end
...
DevAbs:set(ZOLARS..'Abs:Spam:Text'..msg.chat_id_,SetSpam)
...
DevAbs:del(ZOLARS.."Abs:mem:Rd"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:Cleaner:Rd"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:VipMem:Rd"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:Admins:Rd"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:Managers:Rd"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:Constructor:Rd"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:BasicConstructor:Rd"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source ZOLARS     --
...
DevAbs:del(ZOLARS..'Abs:AdminAll:')
end
...
DevAbs:del(ZOLARS..'Abs:ManagerAll:')
end
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
DevAbs:del(ZOLARS..'Abs:AbsConstructor:'..msg.chat_id_)
...
DevAbs:del(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم حذف المنشئين")  
DevAbs:del(ZOLARS..'Abs:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم حذف المدراء")  
DevAbs:del(ZOLARS..'Abs:Managers:'..msg.chat_id_)
end 
...
DevAbs:srem(ZOLARS..'Abs:Tkeed:'..msg.chat_id_, v)
end 
...
DevAbs:del(ZOLARS..'Abs:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔╽تم حذف قوائم المنع")  
DevAbs:del(ZOLARS..'Abs:Filters:'..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:FilterAnimation"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:FilterPhoto"..msg.chat_id_)
DevAbs:del(ZOLARS.."Abs:FilterSteckr"..msg.chat_id_)
end
...
DevAbs:del(ZOLARS..'Abs:Ban:'..msg.chat_id_) DevAbs:del(ZOLARS..'Abs:Admins:'..msg.chat_id_) DevAbs:del(ZOLARS..'User:Donky:'..msg.chat_id_) DevAbs:del(ZOLARS..'Abs:VipMem:'..msg.chat_id_) DevAbs:del(ZOLARS..'Abs:Filters:'..msg.chat_id_) DevAbs:del(ZOLARS..'Abs:Muted:'..msg.chat_id_)
...
local basicconstructor = DevAbs:smembers(ZOLARS..'Abs:BasicConstructor:'..msg.chat_id_)
local constructor = DevAbs:smembers(ZOLARS..'Abs:Constructor:'..msg.chat_id_)
local Managers = DevAbs:smembers(ZOLARS..'Abs:Managers:'..msg.chat_id_)
local admins = DevAbs:smembers(ZOLARS..'Abs:Admins:'..msg.chat_id_)
local vipmem = DevAbs:smembers(ZOLARS..'Abs:VipMem:'..msg.chat_id_)
local donky = DevAbs:smembers(ZOLARS..'User:Donky:'..msg.chat_id_)
...
spam_c = DevAbs:get(ZOLARS..'Abs:Spam:Text'..msg.chat_id_)
end
--     Source ZOLARS     --
if DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source ZOLARS     --
if DevAbs:get(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevAbs:get(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevAbs:get(ZOLARS.."Abs:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source ZOLARS     --
if DevAbs:get(ZOLARS..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevAbs:get(ZOLARS..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevAbs:get(ZOLARS.."Abs:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevAbs:get(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevAbs:get(ZOLARS..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevAbs:get(ZOLARS..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevAbs:get(ZOLARS..'Abs:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevAbs:hget(ZOLARS.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source ZOLARS     --
...
--     Source ZOLARS     --
if DevAbs:get(ZOLARS..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevAbs:del(ZOLARS..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbs:del(ZOLARS..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:rules'..msg.chat_id_,text)
...
DevAbs:set(ZOLARS..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") then
local rules = DevAbs:get(ZOLARS..'Abs:rules'..msg.chat_id_)
...
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل ميزة انطق'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Antk:Abs'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل ميزة انطق'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Antk:Abs'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevAbs:get(ZOLARS..'Abs:Antk:Abs'..msg.chat_id_) and ChCheck(msg) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Zrf:Abs'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل الزخرفه بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Zrf:Abs'..msg.chat_id_,true)  
end
if DevAbs:get(ZOLARS..'Zrf:Abs'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽تم الغاء امر الزخرفه', 1, 'md')
DevAbs:del(ZOLARS..'Zrf:Abs'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevAbs:get(ZOLARS..'Abs:Zrf:Abs'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevAbs:setex(ZOLARS.."Zrf:Abs"..msg.chat_id_..msg.sender_user_id_,300,true)
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Brg:Abs'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل الابراج بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Brg:Abs'..msg.chat_id_,true)  
end
if not DevAbs:get(ZOLARS..'Abs:Brg:Abs'..msg.chat_id_) then
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevAbs:get(ZOLARS..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Age:Abs'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Age:Abs'..msg.chat_id_,true)  
end
if not DevAbs:get(ZOLARS..'Abs:Age:Abs'..msg.chat_id_) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Mean:Abs'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل معاني الاسماء'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Mean:Abs'..msg.chat_id_,true)  
end
if not DevAbs:get(ZOLARS..'Abs:Mean:Abs'..msg.chat_id_) then
...
local ZOLARSTEAM = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
...
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(ZOLARS..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local ZOLARSTEAM = "\n" .."⌔╽الجهات ↫ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(ZOLARS..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local ZOLARSTEAM = "\n" .."⌔╽الماركداون ↫ "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(ZOLARS..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local ZOLARSTEAM = "\n" .."⌔╽الهاشتاك ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
if text == "الفشار" then if DevAbs:get(ZOLARS..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local ZOLARSTEAM = "\n" .."⌔╽الفشار ↫ "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل كشف الاعدادات'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:LockSettings'..msg.chat_id_) 
end
--     Source ZOLARS     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل اوامر التحشيش'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل اوامر التحشيش'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:Stupid'..msg.chat_id_,true)
end
--     Source ZOLARS     --
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:Robot'..msg.chat_id_)
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:Robot'..msg.chat_id_,true)
end
--     Source ZOLARS     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل ردود المدير'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل ردود المدير'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:GpRed'..msg.chat_id_,true)
end
--     Source ZOLARS     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل ردود المطور'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل ردود المطور'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:AllRed'..msg.chat_id_,true)
end
--     Source ZOLARS     --
if SecondSudo(msg) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS.."Abs:Left:Bot"..ZOLARS)
end
if text == 'تعطيل المغادره' or text == '↫ تعطيل المغادره ⌔' then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل المغادره بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS.."Abs:Left:Bot"..ZOLARS,true) 
end 
if text == 'تفعيل الاذاعه' or text == '↫ تفعيل الاذاعه ⌔' then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل الاذاعه بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS.."Abs:Send:Bot"..ZOLARS)
end
if text == 'تعطيل الاذاعه' or text == '↫ تعطيل الاذاعه ⌔' then 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل الاذاعه بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS.."Abs:Send:Bot"..ZOLARS,true) 
end
end
--     Source ZOLARS     --
...
--     Source ZOLARS     --
if msg.content_.photo_ then
if DevAbs:get(ZOLARS..'Abs:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
if data.ID == "Ok" then
DevAbs:del(ZOLARS..'Abs:PinnedMsg'..msg.chat_id_)
...
local PinId = DevAbs:get(ZOLARS..'Abs:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevAbs:del(ZOLARS..'Abs:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevAbs:scard(ZOLARS.."Abs:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevAbs:scard(ZOLARS.."Abs:Constructor:"..ChatId) or 0
local BanedList = DevAbs:scard(ZOLARS.."Abs:Ban:"..ChatId) or 0
local ManagerList = DevAbs:scard(ZOLARS.."Abs:Managers:"..ChatId) or 0
local MutedList = DevAbs:scard(ZOLARS.."Abs:Muted:"..ChatId) or 0
local TkeedList = DevAbs:scard(ZOLARS.."Abs:Abs:Tkeed:"..ChatId) or 0
local AdminsList = DevAbs:scard(ZOLARS.."Abs:Admins:"..ChatId) or 0
local VipList = DevAbs:scard(ZOLARS.."Abs:VipMem:"..ChatId) or 0
...
DevAbs:srem(ZOLARS.."Abs:Groups", dp.id_)
else
...
DevAbs:set(ZOLARS..'Abs:Num:Add:Bot',Num) 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:FreeBot'..ZOLARS) 
end 
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:FreeBot'..ZOLARS,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS..'Abs:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تعطيل الالعاب بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS..'Abs:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" or text == "تفعيل جلب الرابط" then 
if Admin(msg) then
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽تم تفعيل جلب رابط المجموعه'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:del(ZOLARS.."Abs:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(ZOLARS.."Abs:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
--     Source ZOLARS     --
...
ReplyStatus(msg,result.id_,"ReplyBy","⌔╽تم تفعيل المجموعه "..dp.title_)  
DevAbs:sadd(ZOLARS.."Abs:Groups",msg.chat_id_)
if not DevAbs:get(ZOLARS..'Abs:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevAbs:incrby(ZOLARS..'Abs:Sudos'..msg.sender_user_id_,1)
DevAbs:set(ZOLARS..'Abs:SudosGp'..msg.sender_user_id_..msg.chat_id_,"abs")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevAbs:sismember(ZOLARS..'Abs:Groups',msg.chat_id_) then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './ZOLARS.lua', '⌔╽نسخة ملف سورس زولارس',dl_cb, nil)
end end
--     Source ZOLARS     --
...
for k,v in pairs(List) do
local GroupsManagers = DevAbs:scard(ZOLARS.."Abs:Managers:"..v) or 0
local GroupsAdmins = DevAbs:scard(ZOLARS.."Abs:Admins:"..v) or 0
local Groupslink = DevAbs:get(ZOLARS.."Abs:Groups:Links" ..v)
...
if DevAbs:get(ZOLARS.."Abs:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(ZOLARS.."Abs:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevAbs:smembers(ZOLARS..'Abs:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
AbsText = "الرساله"
...
if DevAbs:get(ZOLARS.."Abs:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(ZOLARS.."Abs:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevAbs:smembers(ZOLARS..'Abs:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
AbsText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevAbs:setex(ZOLARS.."Abs:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽ارسل الرساله الان لتوجيها \n⌔╽للخروج ارسل ↫ ( الغاء ) \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAbs:get(ZOLARS.."Abs:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(ZOLARS.."Abs:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevAbs:smembers(ZOLARS..'Abs:Groups')   
for k,v in pairs(List) do  
...
DevAbs:setex(ZOLARS.."Abs:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ZOLARSTEAM = '⌔╽اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔╽ارسل الرساله الان لتوجيها \n⌔╽للخروج ارسل ↫ ( الغاء ) \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ZOLARSTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAbs:get(ZOLARS.."Abs:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(ZOLARS.."Abs:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevAbs:smembers(ZOLARS..'Abs:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم اذاعة رسالتك بالتوجيه \n⌔╽‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
if DevAbs:get(ZOLARS.."Abs:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAbs:del(ZOLARS.."Abs:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevAbs:smembers(ZOLARS.."Abs:Groups") 
if msg.content_.text_ then
...
AbsText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevAbs:set(ZOLARS..'Abs:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
AbsText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevAbs:set(ZOLARS..'Abs:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
AbsText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevAbs:set(ZOLARS..'Abs:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
AbsText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevAbs:set(ZOLARS..'Abs:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
AbsText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevAbs:set(ZOLARS..'Abs:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
AbsText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevAbs:set(ZOLARS..'Abs:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevAbs:get(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevAbs:sismember(ZOLARS..'Abs:Manager:GpRedod'..msg.chat_id_,text) then
...
DevAbs:set(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevAbs:set(ZOLARS..'Abs:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevAbs:set(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = DevAbs:get(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevAbs:set(ZOLARS..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevAbs:set(ZOLARS..'Abs:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevAbs:sadd(ZOLARS..'Abs:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source ZOLARS     --
...
DevAbs:set(ZOLARS..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevAbs:get(ZOLARS..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevAbs:set(ZOLARS..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source ZOLARS     --
...
DevAbs:set(ZOLARS.."Abs:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = DevAbs:get(ZOLARS.."Abs:Add:AllRed"..msg.sender_user_id_)
...
DevAbs:set(ZOLARS.."DelSudoRep",text)
return false 
end end
--     Source ZOLARS     --
...
dp = 'ملف 📁'
elseif DevAbs:get(ZOLARS.."Abs:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
DevAbs:del(ZOLARS..'Abs:Voice:GpRed'..v..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Audio:GpRed'..v..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Photo:GpRed'..v..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Stecker:GpRed'..v..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Video:GpRed'..v..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:File:GpRed'..v..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Text:GpRed'..v..msg.chat_id_)
DevAbs:del(ZOLARS..'Abs:Manager:GpRed'..msg.chat_id_)
end
...
dp = 'ملف 📁'
elseif DevAbs:get(ZOLARS.."Abs:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
DevAbs:del(ZOLARS.."Abs:Gif:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:Voice:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:Audio:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:Photo:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:Stecker:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:Video:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:File:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:Text:AllRed"..v)
DevAbs:del(ZOLARS.."Abs:Sudo:AllRed")
end
...
DevAbs:set(ZOLARS..'Abs:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevAbs:set(ZOLARS..'Abs:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZOLARSTEAM =  DevAbs:get(ZOLARS..'Abs:Help0'..msg.sender_user_id_)
if ZOLARSTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(ZOLARS..'Abs:Help0'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:Help', text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(ZOLARS..'Abs:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZOLARSTEAM =  DevAbs:get(ZOLARS..'Abs:Help01'..msg.sender_user_id_)
if ZOLARSTEAM == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(ZOLARS..'Abs:Help01'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:Help1', text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(ZOLARS..'Abs:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZOLARSTEAM =  DevAbs:get(ZOLARS..'Abs:Help21'..msg.sender_user_id_)
if ZOLARSTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(ZOLARS..'Abs:Help21'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:Help2', text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(ZOLARS..'Abs:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZOLARSTEAM =  DevAbs:get(ZOLARS..'Abs:Help31'..msg.sender_user_id_)
if ZOLARSTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(ZOLARS..'Abs:Help31'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:Help3', text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(ZOLARS..'Abs:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZOLARSTEAM =  DevAbs:get(ZOLARS..'Abs:Help41'..msg.sender_user_id_)
if ZOLARSTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(ZOLARS..'Abs:Help41'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:Help4', text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevAbs:set(ZOLARS..'Abs:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZOLARSTEAM =  DevAbs:get(ZOLARS..'Abs:Help51'..msg.sender_user_id_)
if ZOLARSTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(ZOLARS..'Abs:Help51'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:Help5', text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAbs:set(ZOLARS..'Abs:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ZOLARSTEAM =  DevAbs:get(ZOLARS..'Abs:Help61'..msg.sender_user_id_)
if ZOLARSTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAbs:del(ZOLARS..'Abs:Help61'..msg.sender_user_id_)
DevAbs:set(ZOLARS..'Abs:Help6', text)
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔╽جاري تحديث سورس زولارس', 1, 'md') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARICATEAM/ZOLARSFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔╽قائمة ملفات متجر سورس زولارس\n⌔╽الملفات المتوفره حاليا ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/LARICATEAM/ZOLARSFiles/master/ZOLARSFiles/"..FileName)
if Res == 200 then
...
DevAbs:del(ZOLARS..'Abs:Text:BotWelcome')
DevAbs:del(ZOLARS..'Abs:Photo:BotWelcome')
return false
end 
...
DevAbs:del(ZOLARS..'Abs:Lock:BotWelcome')
return false
end 
...
DevAbs:set(ZOLARS..'Abs:Lock:BotWelcome',true)
return false
end 
...
DevAbs:del(ZOLARS..'Abs:Text:BotWelcome')
DevAbs:del(ZOLARS..'Abs:Photo:BotWelcome')
DevAbs:set(ZOLARS.."Abs:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevAbs:get(ZOLARS.."Abs:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء الامر", 1, "md") 
DevAbs:del(ZOLARS.."Abs:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم حفظ النص ارسل لي صورة الترحيب\n⌔╽ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevAbs:set(ZOLARS.."Abs:Text:BotWelcome",text) 
DevAbs:set(ZOLARS.."Abs:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevAbs:get(ZOLARS.."Abs:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevAbs:set(ZOLARS.."Abs:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevAbs:setex(ZOLARS.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevAbs:del(ZOLARS.."DevText")
end end
--     Source ZOLARS     --
if DevAbs:get(ZOLARS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔╽تم الغاء الامر", 1, "md") 
DevAbs:del(ZOLARS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del(ZOLARS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevAbs:set(ZOLARS..'Abs:ChText',texxt)
...
DevAbs:setex(ZOLARS.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:incr(ZOLARS..'Abs:EditMsg'..result.chat_id_..result.sender_user_id_)
...
local GetMsgPin = DevAbs:get(ZOLARS..'Abs:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevAbs:del(ZOLARS..'Abs:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevAbs:del(ZOLARS..'Abs:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevAbs:srem(ZOLARS..'Abs:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevAbs:srem(ZOLARS..'Abs:Groups',v)  
end
...
DevAbs:sadd(ZOLARS..'Abs:Groups',v)  
end end,nil) end
end
--     Source ZOLARS     --
end 
